...
class FileSystemDatasetClient:
    ...
    async def get_data(self, offset: builtins.int = 0, limit: builtins.int = 999999999999, desc: builtins.bool = False, skip_empty: builtins.bool = False) -> DatasetItemsListPage: ...
...
class FileSystemRequestQueueClient:
    ...
    async def reclaim_request(self, request: typing.Any, forefront: builtins.bool = False) -> typing.Optional[ProcessedRequest]: ...
